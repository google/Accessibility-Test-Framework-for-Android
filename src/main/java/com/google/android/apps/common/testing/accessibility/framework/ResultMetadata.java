...
public interface ResultMetadata {
  ...
  /**
   * Converts this metadata instance to an Android {@link android.os.Bundle}, omitting entries
   * stored using {@link #putNonSerializedObject(String, Object)}
   *
   ...
   *
   * @return an Android-compatible {@link android.os.Bundle} instance containing metadata from this
   *     instance.
   */
